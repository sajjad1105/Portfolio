    ...
    <div>
      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          >
            <TypingEffect text="Hi, I'm Md Sajjad Khan." speed={200} loop={true} />
          </motion.h1>
          ...
          >
            <a
              href="https://drive.google.com/file/d/1zP2qv28WmgEEK5REMmaYfsGZWIAzfBDn/view?usp=drivesdk"
              target="_blank"
            ...
            <a href="mailto:sajjadrockstar8294@gmail.com" className="contact-link shine-button">
              Mail Me
            </a>
          </motion.div>
        </div>
